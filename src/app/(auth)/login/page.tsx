          ...
          <form onSubmit={handleSubmit} className="relative p-6 space-y-5">
            ...
            <div>
              <div className="flex justify-between items-center mb-2">
                ...
                <a href="/forgot-password" className="text-xs text-cyan-400 hover:text-cyan-300">{t("auth.login.forgot")}</a>
              </div>
              <div className="relative">
            ...
            <a
              ...
              className="w-full flex items-center justify-center gap-3 py-3.5 rounded-xl border border-white/[0.08] bg-white/[0.04] hover:bg-white/[0.08] transition-colors text-white font-medium text-sm"
            >
