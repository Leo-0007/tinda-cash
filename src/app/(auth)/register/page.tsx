          ...
          {step === 1 ? (
            <form onSubmit={handleStep1} className="relative p-6 space-y-4">
              ...
              <a
                ...
                className="w-full flex items-center justify-center gap-3 py-3 rounded-xl border border-white/[0.08] bg-white/[0.04] hover:bg-white/[0.08] transition-colors text-white font-medium text-sm"
              >
